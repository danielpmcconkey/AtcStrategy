...
Rewrites eliminate documented anti-patterns, not reproduce them. The master anti-pattern list (`AtcStrategy/POC4/anti-patterns.md`) is your checklist, not a suggestion. Every blueprint must include it as elimination targets. POC2 proved agents can spot anti-patterns and still reproduce them — that's a 0% pass rate on code quality.
